...
function post_url($url, $data, $username = null, $password = null, $soap_action = 'https://stage.lendingclub.com/loanlead/submitQF', $timeout = 200) {
...
function responsive_breadcrumb_lists() {
    ...
    function responsive_widgets_init() {
        ...
        register_sidebar(array(
            'name' => __('Contact Info Desktop', 'responsive'),
            
        ));
		
		 register_sidebar(array(
            'name' => __('Contact Info Mobile', 'responsive'),
            
        ));
		
		 register_sidebar(array(
            'name' => __('Top Menu Mobile', 'responsive'),
		...
		register_sidebar(array(
            'name' => __('How it works', 'responsive'),
            'description' => __('Area 12 - sidebar-how-it-works.php', 'responsive'),
            'id' => 'how-it-works-sidebar',
            'before_title' => '<div class="widget-title">',
            'after_title' => '</div>',
            'before_widget' => '<div id="%1$s" class="widget-wrapper %2$s">',
            'after_widget' => '</div>'
		...
		register_sidebar(array(
            'name' => __('Home Everyloan', 'responsive'),
            'description' => __('Area 12 - sidebar-home-everyloan.php', 'responsive'),
            'id' => 'home-everyloan-sidebar',
            'before_title' => '<div class="widget-title">',
            'after_title' => '</div>',
            'before_widget' => '<div id="%1$s" class="widget-wrapper %2$s">',
            'after_widget' => '</div>'
