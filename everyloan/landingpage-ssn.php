   ...
   <div id="container-inner" class="hfeed">
    ...
    <div class="top-menu-desktop">
      ...
      <div class="contact-info-mobile">
    	<li id="text-7" class="widget widget_text">			<div class="textwidget"><div class="contact-info-mobile">
      ...
      <div class="top-menu-mobile">
             ...
             <li id="text-8" class="widget widget_text">			<div class="textwidget"><nav class="clearfix">
...
<div class="computer"><img src="<?php echo site_url(); ?>/wp-content/themes/responsive/core/images/computer.jpg"/></div>
<div class="lp-top-content">
Find your Rate, Lorem ipsum dolor sit amet, maiores ornare ac fermentum, imperdiet ut vivamus a, nam lectus at nunc. Quam euismod sem, semper ut
</div>
...
<div class="row">
<div class="label-cbb">Current Salary</div>
<label for="fm_currentsalary" style="display:none">Current Salary</label>
...
<p><input class="req ssn" type="text" name="fm_ssn" id="fm_ssn" /></p>
</div>
</div>
...
<div class="widget-wrapper"> 
 ...
 <p><img src="<?php echo site_url(); ?>/wp-content/themes/responsive/core/images/questions.gif"/></p>
