...
<!--</div><!-- end of .post-meta -->
               ...
               <?php if($_SESSION['loan'] == "accepted") { ?> 
      <div class="box-woman-laptop"><span class="title">Congratulations <?php echo $_SESSION['name']; ?>! You have been pre-approved for a loan through our partner Lending Club</span>
      
      
      <p><img src="<?php echo site_url(); ?>/wp-content/themes/responsive/core/images/box-woman-laptop.jpg" style="width:100%"/></p>
      ...
      <p><img src="<?php echo site_url(); ?>/wp-content/themes/responsive/core/images/coming-soon-everyloan.jpg" style="width:100%"/></p>
      ...
      <?php } ?> 
       ...
       <?php if($_SESSION['loan'] == "denied") { ?> 
      <div class="you-may-qualify">
      <div class="lp-top-content-denied">
<div style="color:#555555; font-weight:bold;">Unfortunately, we are unable to approve your application.</div><br>

We consider a number of factors when evaluating loan* applications.Unfortunately, your application was not a match with the stringent credit criteria thatwe use to determine eligibility.
<br><br>
<a href="#">Click here to view the reasons your application was not approved.</a>
</div>
      ...
      <p><img src="<?php echo site_url(); ?>/wp-content/themes/responsive/core/images/placeholder-graphic.jpg"/></p>
      
      <?php } ?> 
      
      
      
        <?php if($_GET['p'] == 'denied') { ?> 
      <div class="you-may-qualify">
      <div class="lp-top-content-denied">
<div style="color:#555555; font-weight:bold;">Unfortunately, we are unable to approve your application.</div><br>
