 ...
 */
  // some hacks to get seo working for ajaxed locations
      ...
      <?php
 			...
 			$address = get_field('address_street', $post_id);
 			echo '<title>Frozen Yogurt ' . $title . " " . $city . ' - 16 Handles Froyo </title>' . PHP_EOL;
 			echo '<meta description="'. $address . ', ' . $title . ', ' . $city . ' | Treat yourself to some delicious Froyo. You deserve it. "/>'. PHP_EOL;
 			echo '</head><body>';?>
 			<h1 class="title"><?php echo $address . ', ' . $title . ',' . $city . ' | Treat yourself to some delicious Froyo. You deserve it. '; ?></h1>
 			<?php 			
 			 $address = get_field('address',$post_id);
       $coordinates = explode(',',$address['coordinates']);
       $features = get_field('features',$post_id);
       $custom_delivery_url = get_field('custom_delivery_url',$post_id);
       ...
       $single_loc = array(
         ...
         'contact' => str_replace(array("\n", "\r"), '', get_field('contact',$post_id)),
         'email'=> get_field('email',$post_id),
         'store_hours'=> get_field('store_hours',$post_id),
         'news'=> str_replace(array("\n", "\r"), '', get_field('news',$post_id)),
         'events'=> str_replace(array("\n", "\r"), '', get_field('events'),$post_id),
         'zipcode'=> get_field('zipcode',$post_id),
         'kosher_icon'=> get_field('kosher_icon',$post_id),
         'state'=> get_field('state',$post_id),
         'custom_delivery_url'=> get_field('custom_delivery_url',$post_id),
         'custom_delivery_image'=> get_field('custom_delivery_image',$post_id),
         'features' => $features,
       );
 			?>
 			  <br />Location:
        <span class="coordinates"> 
          <span><?php $single_loc['featured_image']?></span>
          <span><?php $single_loc['address']?></span>
          <span><?php $single_loc['city']?></span>
          <span><?php $single_loc['state']?></span>
          <span><?php $single_loc['email']?></span>
          <span><?php $single_loc['news']?></span>
          <span><?php $single_loc['events']?></span>
          <span><?php $single_loc['zipcode']?></span>
          <span><?php $single_loc['features']?></span>
        </span>
        <br />Store Hours:
        <span class="store_hours"> 
          <?php echo $single_loc['store_hours']; ?>
        </span>
        <br />Phone:
        <span class="phone"> 
          <?php echo $single_loc['phone']; ?>
        </span>
 			<?php
 			echo '</body></html>';
      // get_footer();
...
{{#custom_delivery_url}}
<a href="{{custom_delivery_url}}" target="_blank"><img src="{{custom_delivery_image}}" class="custom-delivery-image"></a>
{{/custom_delivery_url}}
                            ...
                            <li id="item_{{id}}_1">
                                <div class="content_slide">
                                    ...
                                    <h4 class="title_4"><span class="line"></span>Information<span class="line"></span></h4>
																		<p class="location_meta"><?php echo of_get_option('loc_disclaimer'); ?></p>
                                            ...
                                            <div class="col_1_3">
                                                ...
                                                <div class="field">
                                                    ...
                                                    <input id="datepicker_normal_1" data-gf-field="order_cake_pickup_date" name="date" type="text" placeholder="Pick Up Date"/>
																										<div class="clarification"><p>*Limit pick-up to after 24 hrs. from submission</p></div>
                                                </div>
                                            </div>
                                            <div class="col_1_3">
                                                <div class="field">
                                    ...
                                    <div class="cont_1">
                                        ...
                                        <div class="col_1_3">
                                            ...
                                            <div class="field">
                                                ...
                                                <div class="time">
                                                    <input data-gf-field="party_inquiry_party_time" name="party_inquiry_party_time" id="amount04" class="amount" type="text" />
                                    ...
                                    <div class="cont_1">
                                        ...
                                        <div class="col_1_3">
                                            <div class="field">
                                                <div class="req">*</div>
                                                <div class="date_icon"></div>
                                                <input id="datepicker_normal_3" data-gf-field="catering_inquiry_party_date" name="party_date" type="text" placeholder="Party Date"/>
                                            </div>
                                            <div class="field">
                                                <div class="title"><p>Time</p></div>
                                                <div class="time">
                                                    <input id="amount04" data-gf-field="catering_inquiry_party_time" class="amount" type="text" />
                                                    <div id="thurs" class="ranges"></div>
                                                </div>
                                            </div>
                                        </div>
