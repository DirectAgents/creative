...
function _s_theme_options_init() {
  ...
  //   );
  add_settings_section('social','Social links','__return_false','theme_options');
	...
	add_settings_field(
		...
		'theme_options', // Menu slug, used to uniquely identify the page; see _s_theme_options_add_page()
		'genera' // Settings section. Same as the first argument in the add_settings_section() above
	);

	add_settings_field( 'facebook_url', __( 'Facebook url', '_s' ), '_s_settings_field_sample_text_input', 'theme_options', 'social' );
	add_settings_field( 'pinterest_url', __( 'Pinterest url', '_s' ), '_s_settings_field_sample_text_input', 'theme_options', 'social' );
	add_settings_field( 'twitter_url', __( 'Twitter url', '_s' ), '_s_settings_field_sample_text_input', 'theme_options', 'social' );	
	add_settings_field( 'email_url', __( 'Email url', '_s' ), '_s_settings_field_sample_text_input', 'theme_options', 'social' );	
