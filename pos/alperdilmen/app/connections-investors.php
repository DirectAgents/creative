...
<div class="col-md-6 col-sm-6">
 ...
 <?php 
        ...
        //echo $row_entrepreneur['Type'];
                                        ...
                                        $sql_connections = mysqli_query($connecDB,"SELECT * FROM tbl_connections_".$type." WHERE requester_id = '".$_SESSION['entrepreneurSession']."' AND status != 'denied' AND Type = 'Investor' OR requested_id = '".$_SESSION['entrepreneurSession']."' AND status != 'denied' AND Type = 'Investor' ORDER BY id DESC");                    
        ...
        <tbody>
            ...
            $row_connections[ 'requester_id'] == $_SESSION['entrepreneurSession'] && $row_connections[ 'status']=='accepted' ) {
                                         ...
                                         $row_entrepreneur2= mysqli_fetch_array($sql_entrepreneur);
             }     
