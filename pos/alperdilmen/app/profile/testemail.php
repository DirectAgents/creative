...
$from = new SendGrid\Email(" wants to connect with you", "support@valifyit.com");
$subject = " wants to connect with you";
                                    ...
                                    <div style="display:inline-block; margin: 0 -2px; max-width:600px; vertical-align:top; width:100%;">
                                        ...
                                        <table align="left" border="0" cellpadding="0" cellspacing="0" width="100%">
                                            ...
                                            <tr>
                                              ...
                                              <a href="/connections/" style="text-decoration:none; color:#fff; background:#ff7676; padding:10px; border: 1px solid #ff7676; border-radius: 3px;">Connect +</a>
