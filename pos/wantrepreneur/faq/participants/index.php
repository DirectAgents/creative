            ...
            <a class="brand" href="<?php echo BASE_PATH; ?>">
              ...
              <div class="nav-collapse collapse">
                <ul class="nav">
                        ...
                        <li id="home"><a href="<?php echo BASE_PATH; ?>/participant/login/">Sign in <b class="caret"></b></a></li>
                        <li id="home"><a href="<?php echo BASE_PATH; ?>/participant/signup/">Sign up <b class="caret"></b></a></li>
               ...
               <li><div id="1"></div><strong>What is Valify?</strong></li>
                ...
                <aside id="sidebar" class="span3">
                    ...
                    <ul class="nav nav-list">
                     ...
                     <li><a href="<?php echo BASE_PATH; ?>/faq/startups/">For Startups  <i class="icon-arrow"></i></a></li>
                        
                    
                        
                            <li class="active"><a href="<?php echo BASE_PATH; ?>/faq/participants/">For Participants  <i class="icon-arrow"></i></a></li>
