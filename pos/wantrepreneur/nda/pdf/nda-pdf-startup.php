...
$sqlnda = mysqli_query($connecDB,"SELECT * FROM tbl_nda_signed WHERE startupID='".$_SESSION['startupSession']."' AND ProjectID = '".$_GET['id']."' ");
...
<strong>'.$rowsqlnda['startup_name'].'</strong> and <strong>'.$rowsqlnda['participant_name'].'</strong> are the parties to this agreement. They expect to disclose confidential information to each other for the following idea:<br><br>
...
<p>The laws of the state of <strong>'.$rowsqlnda['State'].'</strong> govern this agreement and any disputes arising from it will be handled exclusively in courts in that state. The prevailing party in any dispute will be entitled to recover reasonable costs and attorneys\' fees.</p>
...
$date2 = new DateTime($rowsqlnda['participant_sig_date']);
$thedate2 =  $date2->format('m/d/Y');
...
<table border="0" cellspacing="3" cellpadding="4">
	...
	<tr>
		...
		<td>&nbsp;</td>
		<td style="width:200px">Name: '.$rowsqlnda['participant_sig_name'].'</td>
	</tr>
	<tr>
