...
<div class='nav-item'>
<a target="_top" href="<?php echo BASE_PATH; ?>">For Entrepreneurs</a>
...
<a class='btn-signin' target="_top" href="<?php echo BASE_PATH; ?>/entrepreneur/login/">Sign In</a>

</div>

<div class='nav-item nav-item-with-button'>
<a class='btn-primary' href='<?php echo BASE_PATH; ?>/entrepreneur/signup/' target='_top'>Sign Up</a>
</div>
...
<li><a target="_top" href="<?php echo BASE_PATH; ?>">For Entrepreneurs</a>
</li>

<li><a target="_top" href="<?php echo BASE_PATH; ?>/participant/">For Participants</a>
</li>

<li><a target="_top" href="<?php echo BASE_PATH; ?>/entrepreneur/login/">Sign In</a>
</li>

<li>
<a href='<?php echo BASE_PATH; ?>/entrepreneur/signup/' target='_top'>Sign Up</a>
</li>
...
<input type="submit" value="Notify Me" name="btn-notify" id="btn-notify" class="hs-button primary large" rel="relativeanchor" data-reactid=".hbspt-forms-0.2.1.0"></div></div>
    ...
    <div class="copyright">
      © 2017 MrPao. All rights reserved  |  <a href="<?php echo BASE_PATH; ?>/terms/">Terms of Service</a>  |  <a href="<?php echo BASE_PATH; ?>/privacy/">Privacy</a>  |  <a href="<?php echo BASE_PATH; ?>/faq/">FAQ</a>  |  <a href="<?php echo BASE_PATH; ?>/about/">About</a>  |  <a href="<?php echo BASE_PATH; ?>/contact/">Contact us</a> 
    </div>
