...
$date_option_one = new DateTime($row['Date_Option_One']);
$date_option_two = new DateTime($row['Date_Option_Two']);
$date_option_three = new DateTime($row['Date_Option_Three']);
...
$from = new SendGrid\Email("Meeting Request Canceled", "support@valifyit.com");
$subject = "Meeting Request Canceled";
                                            ...
                                            <tbody><tr>
                                                ...
                                                <td style="padding: 40px 0 0 0;" class="no-padding">
                                                    ...
                                                    <table border="0" cellspacing="0" cellpadding="0" width="100%">
                                                        ...
                                                        <tr>
                                                            <td align="left" style="padding: 0 0 5px 25px; font-size: 18px; font-family: Helvetica, Arial, sans-serif; font-weight: normal; color: #333333;" class="padding">'.date('F j, Y',strtotime($date_option_one)).' @ '.$row['Time_Option_Three'].'</td>

                                                        </tr>
                                                        <tr>
                                                <td align="left" style="padding: 0 0 5px 25px; font-size: 18px; font-family: Helvetica, Arial, sans-serif; font-weight: normal; color: #333333;" class="padding">'.date('F j, Y',strtotime($date_option_two)).' @ '.$row['Time_Option_Two'].'</td>
                                                        </tr>

                                                         <tr>
                                                            <td align="left" style="padding: 0 0 5px 25px; font-size: 18px; font-family: Helvetica, Arial, sans-serif; font-weight: normal; color: #333333;" class="padding">'.date('F j, Y',strtotime($date_option_three)).' @ '.$row['Time_Option_Three'].'</td>
                                                        </tr>
...
$insert_sql = mysqli_query($connecDB,"INSERT INTO  tbl_meeting_archived_startup(userID, startupID, ProjectID, Viewed_by_Startup, Viewed_by_Participant, Date_of_Meeting, Final_Time, Location, Status, Date_Posted, Time_Posted) VALUES('".$row['userID']."','".$row['startupID']."',
  '".$row['ProjectID']."', 'No', 'No', '".$row['Date_of_Meeting']."', '".$row['Final_Time']."','".$row['Location']."','Meeting Request Canceled','".$the_date."','".$the_time."')");
