...
$sql=mysqli_query($connecDB,"SELECT * FROM tbl_nda_pending WHERE userID = '".$_SESSION['participantSession']."' AND participant_signature = '' ORDER BY id DESC ");
                  ...
                  <div class="survey-metadata">
                    ...
                    <div class="item date">
                      ...
                      <div class="value">
                       ...
                       <?php if($row2['participant_signature'] == ''){ ?>
                          Waiting to be signed before meeting
                       <?php } ?>
                        </span>
                      </div>
                    </div>
...
<div class="row">
    <div class="col-md-12">
<div class="empty-projects">No pending NDAs'</div>
