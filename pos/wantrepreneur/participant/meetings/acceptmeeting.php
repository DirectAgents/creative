...
if($screening_passed == 'Passed' || $screening_passed == 'Not required'){
                                            ...
                                            <tr>
                                                ...
                                                <td style="padding: 40px 0 0 0;" class="no-padding">
                                                    ...
                                                    <table border="0" cellspacing="0" cellpadding="0" width="100%">
                                                        ...
                                                        <tr>
                                                            <td align="left" style="padding: 0 0 5px 25px; font-size: 18px; font-family: Helvetica, Arial, sans-serif; font-weight: normal; color: #333333;" class="padding">'.$row2['Phone'].'</td>
                                                        </tr>
                        ...
                        <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width:600;">
                            <tbody><tr>
                              ...
                              <tr>
                               ...
                               <tr>
                                <td align="left" valign="top" style="padding: 0 0 5px 25px; font-size: 14px; font-family: Helvetica, Arial, sans-serif; font-weight: normal; color: #333333;">Before the date of your meeting approaches, please get in touch with '.$row2['FirstName'].' over the phone.</td>
                              </tr>
