...
$sql="SELECT * FROM tbl_startup_project WHERE startupID = '".$_SESSION['startupSession']."' AND ProjectID = '".$_GET['projectid']."'";
...
$sqlproject="SELECT * FROM tbl_project_request WHERE ProjectID = '".$_GET['projectid']."' AND startupID = '".$_SESSION['startupSession']."' AND userID = '".$_GET['participantid']."' ";
...
$.ajax({
    url: 'send-payment/index.php?projectid='+projectid+'&participantid='+participantid+'&startupid='+startupid,
    cache: false,
...
<div id="myModal" class="modal fade" role="dialog">
  ...
  <input type="hidden" name="startupid" id="startupid" value="<?php echo $_GET['startupid']; ?>"/>
