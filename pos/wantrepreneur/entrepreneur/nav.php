  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        <li class="dropdown">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><img src="<?php echo BASE_PATH; ?>/startup/account/profile/images/<?php echo $_SESSION['profileimage']; ?>" class="img-circle-profile-nav"> <span class="caret"></span></a>
          <ul class="dropdown-menu">
