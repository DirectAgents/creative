    ...
    $("#submit_btn").click(function() { 
        ...
        if(proceed) //everything looks good! proceed...
        {
            ...
            post_data = {
                ...
                'test'     :    $('input[name="meetupselection[]"]:checked').map(function () {return this.value;}).get().join(",")
...
<div class="form-style" id="contact_form">
    ...
    <div id="contact_body">
        ...
        <label><span>Phone</span>
            <input type="text" name="phone1" maxlength="4" placeholder="+91"  class="tel-number-field"/>&mdash;<input type="text" name="phone2" maxlength="15" class="tel-number-field long" />
        </label>
        ...
        <label for="field5"><span>Message <span class="required">*</span></span>
          ...
          <div class="input-inline first">
            <div class="wrapper">
              <!--<h3>In Person</h3>-->
              <div class="in-person">
               <input id="in-person" name="meetupselection[]" type="checkbox" value="In Person" />
          ...
          <div class="input-inline">
            <div class="wrapper">
              ...
              <div class="google-hangout">
               <input id="google-hangout" name="meetupselection[]" type="checkbox" value="Google Hangout"/>
          ...
          <div class="input-inline numberSurveys">
            <div class="wrapper">
              ...
              <div class="over-the-phone">
               <input id="over-the-phone" name="meetupselection[]" type="checkbox" value="Over the Phone" />
