...
$insert_sql = "INSERT INTO tbl_project_request(userID, startupID, ProjectID, Day, From_Time, To_Time, Location, Accepted_To_Participate, Requested_By, Date_Posted, Time_Posted) 
VALUES('".$_SESSION['participantSession']."', '".$_POST['startupid']."','".$_POST['projectid']."','".$_POST['day']."', '".$_POST['fromtime']."', '".$_POST['totime']."', '".$_POST['location']."' , 'Pending', 'Participant' ,'".$the_date."','".$the_time."')";
