...
$Project = mysql_query("SELECT * FROM tbl_researcher_project WHERE Category='".$_GET['cat']."'");
$rowproject = mysql_fetch_array($Project);

}else{

$Project = mysql_query("SELECT * FROM tbl_researcher_project");
$rowproject = mysql_fetch_array($Project);
}
...
$sql="SELECT * FROM tbl_researcher_project WHERE Category = '".$_GET['cat']."' ORDER BY id DESC ";
$result=mysql_query($sql);

}else{

$sql="SELECT * FROM tbl_researcher_project ORDER BY id DESC ";
$result=mysql_query($sql);
}
...
<img src="<?php echo BASE_PATH; ?>/projects/<?php echo $row2['Category']; ?>/uploads/<?php echo $rowprojectimage['project_image']; ?>" width="100">
