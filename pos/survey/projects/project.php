...
$Project = mysqli_query($connecDB,"SELECT * FROM tbl_researcher_project WHERE ProjectID='".$_GET['id']."'");
...
$researcher = mysqli_query($connecDB,"SELECT * FROM tbl_researcher_project WHERE researcherID='".$_SESSION['researcherSession']."' AND ProjectID = '".$_GET['id']."'");
$rowresearcher = mysqli_fetch_array($researcher);

if(mysqli_num_rows($researcher)<0)
{
...
$sql3 = mysqli_query($connecDB,"SELECT * FROM `tbl_participant` AS p INNER JOIN `tbl_researcher_project` AS r ON p.userID='".$_SESSION['participantSession']."'
...
<div class="col-lg-9"><h3>Payout</h3><span class="details-box">$<?php echo $rowproject['Pay']; ?></span> for <span class="details-box"><?php echo $rowproject['Minutes']; ?></span> minutes of your time</span></div>


    <div class="col-lg-12">
      <h3><?php echo $rowproject['Name']; ?></h3>
      <span class="details"><?php echo $rowproject['Headline']; ?></span>
      </div>
