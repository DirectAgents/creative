...
$insert_sql = "INSERT INTO tbl_project_request(userID, researcherID, ProjectID, Date_of_Meeting, From_Time, To_Time, Location, Accepted_to_Participate, Status, Requested_By, Date_Posted, Time_Posted) 
VALUES('".$_SESSION['participantSession']."', '".$_POST['researcherid']."','".$_POST['projectid']."','".$_POST['date']."', '".$_POST['fromtime']."', '".$_POST['totime']."', '".$_POST['location']."' , 'Pending', 'Waiting for Researcher to Accept or Decline', 'Participant' ,'".$the_date."','".$the_time."')";
...
$sql5 = mysql_query("SELECT * FROM tbl_researcher WHERE researcherID='".$_POST['researcherid']."'");
