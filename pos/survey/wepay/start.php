...
WePay.OAuth2.button_init(document.getElementById('start_oauth2'), {
    ...
    "redirect_uri":"http://localhost/survey/wepay/",
    ...
    "callback":function(data) {
		...
		if (data.code.length !== 0) {
			...
			window.location.href = "http://localhost/survey/wepay/oauth2/token/?client_id=131244&code="+data.code+"&redirect_uri=http://localhost/survey/wepay/&client_secret=5a612c797c&code="+data.code;
