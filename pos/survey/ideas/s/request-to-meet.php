...
VALUES('".$_POST['participantid']."', '".$_SESSION['startupSession']."','".$_POST['projectid']."', 'Meeting Requests' ,'".$_POST['days_availability_option']."', '".$_POST['final_time_option']."', '".$_POST['location_option']."' , 'Pending', 'Waiting for Participant to Accept or Decline', 'Startup' , '".$the_date."','".$the_time."')");
