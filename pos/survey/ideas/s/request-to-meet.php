...
$rownda = mysqli_fetch_array($sqlnda);
 ...
 $sql=mysqli_query($connecDB,"INSERT INTO tbl_nda_pending (status, userID, startupID, ProjectID, State, startup_name , nda_purpose,startup_signature ,startup_sig_name, startup_sig_title, startup_sig_company, startup_sig_date ) VALUES ('pending', '".$_POST['participantid']."' ,'".$_SESSION['startupSession']."', '".$_POST['projectid']."', '".$rownda['State']."'  ,'".$rownda['startup_name']."', '".$rownda['nda_purpose']."','".$rownda['startup_signature']."','".$rownda['startup_sig_name']."', '".$rownda['startup_sig_title']."', '".$rownda['startup_sig_company']."', '".$rownda['startup_sig_date']."')");
