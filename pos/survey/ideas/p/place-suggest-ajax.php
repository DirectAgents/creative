...
$insert_sql = mysqli_query($connecDB,"INSERT INTO tbl_project_request(userID, startupID, ProjectID, Meeting_Status, Date_of_Meeting, From_Time, To_Time, Location, Accepted_to_Participate, Status, Requested_By, Potential_Answer_Given, Date_Posted, Time_Posted) 
VALUES('".$_SESSION['participantSession']."', '".$_POST['startupid']."','".$_POST['projectid']."', 'Meeting Request' ,'".$_POST['date']."', '".$_POST['fromtime']."', '".$_POST['totime']."', '".$_POST['location']."' , 'Pending', 'Waiting for Startup to Accept or Decline', 'Participant' , '".$_POST['potentialanswergiven']."','".$the_date."','".$the_time."')");
...
$sql5 = mysqli_query($connecDB,"SELECT * FROM tbl_startup WHERE startupID='".$_POST['startupid']."'");
...
$mail->addAddress($row5['userEmail']);
                                            ...
                                            <tr>
                                                ...
                                                <td style="padding: 40px 0 0 0;" class="no-padding">
                                                    ...
                                                    <table border="0" cellspacing="0" cellpadding="0" width="100%">
                                                        ...
                                                        <tr>
                                                             <td align="left" style="padding: 10px 0 15px 25px; font-size: 16px; line-height: 24px; font-family: Helvetica, Arial, sans-serif; color: #666666;" class="padding">'.$row['Day'].' @ '.$_POST['fromtime'].'</td>
                                                        </tr>

                                                         <tr>
                                                             <td align="left" style="padding: 10px 0 15px 25px; font-size: 16px; line-height: 24px; font-family: Helvetica, Arial, sans-serif; color: #666666;" class="padding">'.date('F j, Y',strtotime($_POST['date'])).' </td>
                                                        </tr>
