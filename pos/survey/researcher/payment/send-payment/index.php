...
$stmt = $researcher_home->runQuery("SELECT * FROM tbl_researcher WHERE userID='".$_GET['researcherid']."'");
$stmt->execute(array(":uid"=>$_GET['researcherid']));
...
$stmtproject="SELECT * FROM tbl_researcher_project WHERE researcherID='".$_GET['researcherid']."' AND ProjectID = '".$_GET['projectid']."' ";
...
//continue here
   $insert_sql = "INSERT INTO wepay(ProjectID, researcher_id, participant_id, order_by, account_id, checkout_id, checkout_find_date, checkout_find_amount, fees, total) VALUES('".$_GET['projectid']."','".$_GET['researcherid']."','".$_GET['participantid']."', '".$order_by."' ,'".$checkout -> account_id."', '".$checkout -> checkout_id."', '".$checkout_find_date."','".$checkout -> amount."',
