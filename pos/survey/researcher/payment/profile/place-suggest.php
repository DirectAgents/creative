...
//$screening=explode(',',$rowprofileimage['Screening']);
  ...
  <div class="span12">
    ...
    <div id="create-project-box">
      <div id="create-project">
              <a href="<?php echo BASE_PATH; ?>/researcher/project/browse/profile/?id=<?php echo $_GET['id'];?>&p=<?php echo $_GET['p'];?>" class="initialism btn-back">Back</a>
