...
$sql=mysqli_query($connecDB,"SELECT * FROM tbl_project_request WHERE researcherID = '".$_SESSION['researcherSession']."' AND Status = 'Meeting Set' ORDER BY id DESC ");
...
<?php 
$sql5=mysqli_query($connecDB,"SELECT * FROM c5t_comment WHERE researcher_id = '".$_SESSION['researcherSession']."' AND comment_identifier_id = '".$row2['userID']."'");
...
if($row2['Met'] == 'Yes' && $row2['Met'] != 'No didn\'t show up' && $row5['researcher_id'] != $_SESSION['researcherSession']){ ?>
