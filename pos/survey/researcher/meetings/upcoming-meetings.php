...
$sql=mysqli_query($connecDB,"SELECT * FROM tbl_project_request WHERE researcherID = '".$_SESSION['researcherSession']."' AND Status = 'Meeting Set' AND Accepted_to_Participate = 'Accepted' ORDER BY id DESC ");
...
<div class="empty-projects">No Upcoming Meetings</div>
  <div class="create-one-here-box">
      <br><br>
      <a href="<?php echo BASE_PATH; ?>/researcher/project/browse/">
