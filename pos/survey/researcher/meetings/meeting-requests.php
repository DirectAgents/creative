...
$sql=mysqli_query($connecDB,"SELECT * FROM tbl_project_request WHERE researcherID = '".$_SESSION['researcherSession']."' AND Accepted_to_Participate = 'Pending' AND Status != 'Canceled_by_Participant'  ORDER BY id DESC ");
...
$sql3=mysqli_query($connecDB,"SELECT * FROM tbl_researcher WHERE userID = '".$row2['researcherID']."'");
...
<?php if($row2['Status'] == 'Waiting for Researcher to accept') { ?>
           ...
           <?php if($row2['Status'] == 'Waiting for Researcher to Accept or Decline') { ?>
           ...
           <?php } ?>      
            ...
            <?php if($row2['Status'] == 'Waiting for Participant to accept') { ?>
                  ...
                  <?php if($row2['Status'] == 'Waiting for Researcher to Accept or Decline'){echo 'Waiting for you to Accept or Decline';} ?>
