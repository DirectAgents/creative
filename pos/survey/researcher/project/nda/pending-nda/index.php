...
$stmt = $researcher_home->runQuery("SELECT * FROM tbl_nda WHERE researcherID=:uid");
...
$nda = mysqli_query($connecDB,"SELECT * FROM tbl_nda WHERE researcherID='".$_SESSION['researcherSession']."' AND participant_signature != '' ");
$rownda = mysqli_fetch_array($nda);


$Project = mysqli_query($connecDB,"SELECT * FROM tbl_researcher_project WHERE researcherID='".$_SESSION['researcherSession']."' AND ProjectID = '".$_GET['id']."' ");
...
$sql=mysqli_query($connecDB,"SELECT * FROM tbl_nda WHERE researcherID = '".$_SESSION['researcherSession']."' AND participant_signature != '' ORDER BY id DESC ");
    ...
    <div class="col-md-12">
                  ...
                  <div class="survey-header">
                    ...
                    <div class="edit-delete">
                      <a href="<?php echo BASE_PATH; ?>/researcher/project/nda/?id=<?php echo $row2['ProjectID']; ?>">
                  <i class="icon icon-pencil"></i> Edit</a>&nbsp;&nbsp;&nbsp;| &nbsp;
                  <a href="<?php echo BASE_PATH; ?>/researcher/project/nda/nda-pdf.php?id=<?php echo $row2['ProjectID']; ?>" role="button" target="_blank">
                  ...
                  <div class="survey-metadata">
                    <div class="item ">
                      ...
                      <div class="value" ng-bind="(survey.date | date:'MM/dd/yyyy')"><?php echo $rownda['researcher_sig_date']; ?></div>
                    </div>
                    <div class="item date">
