...
$nda = mysqli_query($connecDB,"SELECT * FROM tbl_nda WHERE researcherID='".$_SESSION['researcherSession']."' AND status = 'draft' ");
...
$sql=mysqli_query($connecDB,"SELECT * FROM tbl_nda WHERE researcherID = '".$_SESSION['researcherSession']."' AND status = 'draft' ORDER BY id DESC ");
    ...
    <div class="col-md-12">
                  ...
                  <div class="survey-header">
                    ...
                    <div class="edit-delete">
                      <a href="<?php echo BASE_PATH; ?>/researcher/project/nda/edit/?id=<?php echo $row2['ProjectID']; ?>">
                  <i class="icon icon-pencil"></i> Edit</a>&nbsp;&nbsp;&nbsp;| &nbsp;
                  <a href="<?php echo BASE_PATH; ?>/researcher/project/nda/pdf/?id=<?php echo $row2['ProjectID']; ?>" role="button" target="_blank">
