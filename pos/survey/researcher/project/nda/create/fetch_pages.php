...
<div class="col-lg-2"><input type="text" style="width:250px" name="researcher_sig_title" id="researcher_sig_title" placeholder="Your Title (optional)"  /></div>
</div>
...
<div class="col-lg-4"><input type="text" style="width:250px" name="researcher_sig_company" id="researcher_sig_company" placeholder="Your Company Name (optional)" /></div>
</div>
...
<input type="text" style="width:250px" name="researcher_sig_date" id="researcher_sig_date" placeholder="Today's Date" />
