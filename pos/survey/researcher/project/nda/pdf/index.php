...
$pdf->SetAuthor($rowsqlnda['researcher_name']);
...
<strong>'.$rowsqlnda['researcher_name'].'</strong> and <strong>'.$rowsqlnda['participant_name'].'</strong> are the parties to this agreement. They expect to disclose confidential information to each other for the following purpose:<br><br>
...
<table border="0" cellspacing="3" cellpadding="4">
	...
	<tr>
		<td style="text-align:left;"><img src="../signatures/'.$rowsqlnda['researcher_signature'].'" border="0" height="100" width="250" align="top" /></td>
		<td style="text-align:left;"><img src="../signatures/'.$rowsqlnda['participant_signature'].'" border="0" height="41" width="41" align="top" /></td>
	</tr>
	<tr>
		<td>Name: '.$rowsqlnda['researcher_sig_name'].'</td>
		<td>Name: '.$rowsqlnda['participant_sig_name'].'</td>
	</tr>
	<tr>
		<td>Title: '.$rowsqlnda['researcher_sig_title'].'</td>
		<td></td>
		<td></td>
		<td>Date: '.$rowsqlnda['participant_sig_date'].'</td>
	</tr>
	<tr>
		<td>Company: '.$rowsqlnda['researcher_sig_company'].'</td>
		<td></td>
		<td></td>
		<td></td>
	</tr>
	<tr>
		<td>Date: '.$rowsqlnda['researcher_sig_date'].'</td>
		<td></td>
		<td></td>
		<td>&nbsp;</td>
	</tr>
