...
$Project = mysql_query("SELECT * FROM tbl_researcher_project WHERE researcherID='".$_SESSION['researcherSession']."' AND ProjectID = '".$_GET['id']."'");
...
<link rel="stylesheet" href="<?php echo BASE_PATH; ?>/researcher/project/js/jquery-ui.css">
...
$(".load_more_pending").click(function (e) { //user clicks on button
    ...
    {
      //post page number and load returned data into result element
      $.post('load_more_pending.php?id='+<?php echo $_GET['id']; ?>,{'page': track_click}, function(data) {
