...
$redirect_uri = ''.BASE_PATH.'/researcher/signup/';
...
<script src="<?php echo BASE_PATH; ?>/researcher/js/password.js"></script>
...
if($_POST['passwordpass'] == 'good'){
  ...
  $stmt = $reg_user->runQuery("SELECT * FROM tbl_researcher WHERE userEmail=:email_id");
  ...
  else
  {
    ...
    {     
      ...
      $message = "          
            ...
            <br /><br />
            <a href='http://localhost/survey/researcher/account/verify.php?id=$id&code=$code'>Click HERE to Activate :)</a>
            <br /><br />
            Thanks,";
...
$loginUrl = $helper->getLoginUrl(''.BASE_PATH.'/researcher/signup/signup-callback.php', $permissions);
