...
--
-- Host: localhost
-- Generation Time: Sep 27, 2016 at 11:53 PM
...
CREATE TABLE `participant_profile_images` (
  `id` int(11) NOT NULL,
...
(3, 'Hanelore', 'Peterson', 'hanne@yahoo.com', 'c4ca4238a0b923820dcc509a6f75849b', '', 'In Person', '1', '9172872872', '19', 'Male', '', 'Divorced', 'White', '', '', '', '', '', '', '', '', '', 'New York, New York', 'NY', '', '', '', 'Yo', '0000-00-00', '', '', '', '0000-00-00', '0', '', '', '0000-00-00', '', '', '', '5:30pm', '07:00pm', '', '', '', '', '', '', '', '', '', '', '', '', '745 5th Avenue, New York, NY, United States', '', '', '', '', '', '', 'Y', '35db263e7c9c68ab37cb9d83cca37df7', '', '', '', '', '', '', '0000-00-00'),
(4, 'Mike', 'Peter', 'franz@yahoo.com', 'c4ca4238a0b923820dcc509a6f75849b', '', 'In Person', '', '', '15', 'Female', '55', '', 'Asian', '', '', '', '', '', '', '', '', '', 'New York, New York', 'NY', '', '', '', '', '0000-00-00', '', '', '', '0000-00-00', '0', '', '', '0000-00-00', '', '', '', '06:00pm', '09:00pm', '', '', '', '', '', '', '', '', '', '', '', '', '745 5th Avenue, New York, NY, United States', '', '', '', '', '', '', 'Y', '', '', '', '712591703', '225647674', 'STAGE_5029820579b8aa43cea05c37ed7d4bde8bc86d51613086e502807e52ca66ede2', '', '0000-00-00'),
(5, 'ASDF', 'SADFSA', '', '', '', 'In Person', '', '', '18', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '0000-00-00', '', '', '', '0000-00-00', '0', '', '', '0000-00-00', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 'N', '', '', '', '', '', '', '', '0000-00-00'),
(6, 'Franco', 'Banco', 'ald183s@gmail.com', 'c4ca4238a0b923820dcc509a6f75849b', 'When you qualify for new projects', 'In Person', '', '9173737382', '15', 'Female', '50', 'Sinlge', 'Asian', 'Trying to quit', 'Very Often', 'Vegetarian', 'Agnostic', 'University', 'Education', 'Arts and Entertainment,Business and Career,Communities and Lifestyles,Internet and Technology,Parenting and Family,Pets and Animals,Science,Social,Sports and Recreation', '', '1111', 'New York', 'AL', '1111', 'AD', '', '', '2016-09-28', '11:00am', '07:00pm', '312 Lexington Avenue, New York, NY, United States', '2016-09-28', '06:00am', '06:00pm', '212 Broadway, Brooklyn, NY, United States', '2016-09-25', '04:00pm', '10:00pm', '123 Broadway, Brooklyn, NY, United States', '', '', '11:00am', '05:00pm', '08:00am', '12:00pm', '12:00pm', '08:00pm', '09:00am', '05:00pm', '12:00pm', '05:00pm', '07:00am', '05:00pm', '212 Broadway, Brooklyn, NY, United States', '431 Broome Street, New York, NY, United States', '32 Lexington Avenue, Passaic, NJ, United States', '232 Lexington Avenue, Malverne, NY, United States', '112 Lexington Ave, Jersey City, NJ, United States', '123 Lexington Avenue, Dumont, NJ, United States', '1225 Broadway, Brooklyn, NY, United States', 'Y', '959199756aeb2470fc73d9a8d5a61a66', '6_13522563_10153780777487992_30567582_n.jpg', '1', '1617595990', '258160103', 'STAGE_5290543f71b8064017b85e1d0d19f45d258d18d4024781e1edbe6408e707c70d', '71977b9c1f3ba302cd024b45e6cbf44ffb743cd3b7fea2a590', '0000-00-00'),
(26, 'flu', 'blue', 'asdfasdf@lakjdsf.com', 'b8150db267de096dd2573e6d91882778', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '0000-00-00', '', '', '', '0000-00-00', '0', '', '', '0000-00-00', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 'N', '28b09f4ce821632955e35c6d6d12d261', '', '', '', '', '', '', '2016-07-19');
...
CREATE TABLE `tbl_participant_interests` (
  `id` int(11) NOT NULL,
  `userID` int(11) NOT NULL,
...
CREATE TABLE `tbl_participant_languages` (
  `id` int(11) NOT NULL,
  `userID` int(11) NOT NULL,
...
(69, 6, 32, 16774, '', '2016-09-30', 'Monday', '12:00pm', '1:30pm', '12:30pm', 'Starbucks, Astor Place, New York, NY, United States', 'Accepted', '', 'Meeting Set', 'Participant', '', '', '2016-09-09', '03:49:54 PM'),
...
CREATE TABLE `tbl_researcher_interests` (
  `id` int(11) NOT NULL,
  `userID` int(11) NOT NULL,
  `ProjectID` int(11) NOT NULL,
  `Interests` varchar(255) NOT NULL
...
CREATE TABLE `tbl_researcher_potentialanswers` (
  `id` int(11) NOT NULL,
  `userID` int(11) NOT NULL,
  `ProjectID` int(11) NOT NULL,
...
CREATE TABLE `tbl_researcher_project` (
  `id` int(11) NOT NULL,
  `ProjectID` int(11) NOT NULL,
...
(134, 76340, 'tech', 32, 'Project 1', 'In Person', '15', 'Female', '50', '60', 'NULL', 'NULL', 'NULL', 'NULL', 'NULL', 'NULL', 'NULL', 'NULL', 'NULL', 'NULL', 'NULL', 'NULL', 'NULL', '', '', '', 'Yo', 'asdfasdfa', '', '', '', '77218_Screen_Shot_2016-03-18_at_11.09.45_AM.png', '2016-07-01', '0000-00-00', '', 'Y'),
(138, 28750, 'tech', 32, 'Project 2', 'In Person', '15', 'Female', '50', '60', 'NULL', 'NULL', 'NULL', 'NULL', 'NULL', 'Sinlge', 'Asian', 'Yes', 'Very Often', 'Vegetarian', 'Agnostic', 'High School', 'Technology', 'accounting,advertising', 'EN,DE', '', '', '', '', '', '', '', '2016-07-06', '0000-00-00', '', 'N'),
(152, 16774, 'games', 32, 'Project 3', 'In Person', '15', 'Female', '50', '60', 'NULL', 'NULL', 'NULL', 'NULL', 'NULL', 'NULL', 'NULL', 'NULL', 'NULL', 'NULL', 'NULL', 'NULL', 'Education', '', '', '', '', '', '', '', '', '', '2016-06-13', '0000-00-00', '', 'N');
...
CREATE TABLE `tbl_researcher_screening` (
  `id` int(11) NOT NULL,
  `userID` int(11) NOT NULL,
  `ProjectID` int(11) NOT NULL,
