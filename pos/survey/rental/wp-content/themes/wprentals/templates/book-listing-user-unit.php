        ...
        <div class="prop-info">
            ...
            <?php  if($to_be_paid>0 && $booking_status_full!='confirmed') { ?>
                <div class="user_dashboard_listed" style="color:red;">
                   <strong><?php esc_html_e('Balance: ','wpestate');?> </strong> <?php print $to_be_paid_show.' '.__('to be paid until ','wpestate').' '.$booking_from_date; ?>  
                </div> 
            <?php } ?>
        ...
        <div class="info-container_booking">
            ...
            if ($booking_status=='confirmed'){
                if($booking_status_full=='confirmed'){
                    print '<span class="tag-published">'.esc_html__( 'Confirmed & Paid','wpestate').'</span>';
                }else{
                    print '<span class="tag-published">'.esc_html__( 'Confirmed','wpestate').'</span>';
                    print '<span class="proceed-payment_full" data-invoiceid="'.$invoice_no.'" data-bookid="'.$post->ID.'">'.esc_html__( 'Pay Invoice in Full','wpestate').'</span>';                  
