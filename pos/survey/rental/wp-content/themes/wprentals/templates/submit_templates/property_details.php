...
-->
                ...
                if( !empty($custom_fields)){  
                    while($i< count($custom_fields) ){
                        ...
                        print '<div class="col-md-6"><p><label for="'.$slug.'">'.stripslashes( $label ).'</label>';
                        ...
                        if ($type=='long text'){
                            ...
                            print '<select class="select-submit2" id="'.$slug.'"  name="'.$slug.'" >';
                            ...
                            foreach($dropdown_values_array as $key=>$value_drop){
                                ...
                                print '>'.trim( stripslashes( $value_drop ) ).'</option>';
                            }
                            print '</select>';
