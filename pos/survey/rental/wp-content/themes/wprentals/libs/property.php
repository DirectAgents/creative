...
function details_estate_box($post) {
    ...
    <tr >
        <td width="33%" valign="top" align="left">
            <p class="meta-options">
            <label for="property_taxes">'.esc_html__( 'Taxes in % (taxes are considered included in the daily price): ','wpestate').'</label><br />
    ...
    <tr >
        ...
        <td width="33%" valign="top" align="left">
                <p class="meta-options">
                    <label for="cleaning_fee_per_day">'.esc_html__( 'Cleaning Fee for:','wpestate').'</label><br />
    ...
    <tr >
        ...
        <td width="33%" valign="top" align="left">
            <p class="meta-options">
                <label for="city_fee_per_day">'.esc_html__( 'City Fee for:','wpestate').'</label><br />
        ...
        <td width="33%" valign="top" align="left">
            <p class="meta-options"> 
                ...
                print' />
                <label for="city_fee_percent">'.esc_html__( 'City Fee is a % of the daily fee','wpestate').'</label>
            </p>
        </td>
    </tr>
