...
class AnpsOpeningTime extends WP_Widget {
    public function __construct() {
        parent::__construct('AnpsOpeningTime', 'AnpsThemes - Opening time', array('description' => esc_html__('Enter opening time.', 'construction')));
    }
        ...
        <div data-anps-repeat>
            ...
            <div class="anps-repeat-items" data-anps-repeat-items>
                ...
                <div class="anps-repeat-item" data-anps-repeat-item>
                    <!-- Day -->
                    <p>
                        <label><?php esc_html_e('Day', 'construction'); ?></label>
                        <input type="text" class="widefat" value="<?php echo esc_attr($day); ?>" />
                    </p>

                    <!-- Time -->
                    <p>
                        <label><?php esc_html_e('Time', 'construction'); ?></label>
                        <input type="text" class="widefat" value="<?php echo esc_attr($time); ?>" />
                    </p>

                    <!-- Exposed -->
                    <p>
                        <label><?php esc_html_e('Exposed', 'construction'); ?></label>
                        <input type="checkbox" id="exposed" name="exposed" style="margin-left: 5px;" <?php if( $exposed == 'true' ) { echo 'checked'; } ?> />
                    </p>                    
        ...
        <table class="working-hours">
           <tbody>
                <?php foreach($opening_times as $opening_time): ?>
                    ...
                    ?>
                    <tr>
                        <th<?php if( $exposed == 'true' ) { echo ' class="important"'; } ?>><?php echo $day; ?></th>
                        <td<?php if( $exposed == 'true' ) { echo ' class="important"'; } ?>><?php echo $time; ?></td>
                    </tr>
                <?php endforeach; ?>
           </tbody>
        </table>
