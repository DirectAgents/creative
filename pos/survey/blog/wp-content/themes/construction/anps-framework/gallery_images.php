...
class Gallery_images {
    ...
    function gallery_images_box() {
                                    ...
                                    if ( $attachments )
                                            foreach ( $attachments as $attachment_id ) {
                                                    echo '<li class="image" data-attachment_id="' . esc_attr($attachment_id) . '">
                                                            ...
                                                            <ul class="actions">
                                                                    <li><a href="#" class="delete" title="' . esc_html__( 'Delete image', 'construction' ) . '">' . esc_html__( 'Delete', 'construction' ) . '</a></li>
                                                            </ul>
                                                    </li>';
                                            }
                            ?>
            ...
            <p class="add_product_images hide-if-no-js">
                    <a href="#"><?php _e( 'Add gallery images', 'construction' ); ?></a>
            </p>
                    ...
                    jQuery(document).ready(function($){
                            ...
                            jQuery('.add_product_images').on( 'click', 'a', function( event ) {
                                    ...
                                    product_gallery_frame = wp.media.frames.downloadable_file = wp.media({
                                            ...
                                            title: '<?php _e( 'Add Images to Gallery', 'construction' ); ?>',
                                            button: {
                                                    text: '<?php _e( 'Add to gallery', 'construction' ); ?>',
                                            },
                                            multiple: true
                                    });
                                                    ...
                                                    if ( attachment.id ) {
                                                            ...
                                                            $product_images.append('\
                                                                    <li class="image" data-attachment_id="' + attachment.id + '"">\
                                                                            ...
                                                                            <ul class="actions">\
                                                                                    <li><a href="#" class="delete" title="<?php _e( 'Delete image', 'construction' ); ?>"><?php _e( 'Delete', 'construction' ); ?></a></li>\
                                                                            </ul>\
                                                                    </li>');
                                                    }
    ...
    function image_meta() {
        ...
        foreach($page as $item) {
            add_meta_box( 'gallery_images', esc_html__( 'Gallery images', 'construction' ), array(&$this,'gallery_images_box'), $item,'side');
        }
    }
