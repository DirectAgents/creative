...
<a href='<?php echo BASE_PATH; ?>/startup/signup/' target='_top'>Sign Up</a>
  ...
  <header class="hero">
    ...
    <div class="wrap">
      ...
      <span class="description">
        One platform to easily validate your idea before you spend more time and money to grow.
      </span>
  ...
  <section class="value">
    <div class="prop">
      <div class="icon">
        <img src="images/vectorgraphs/business-background-with-colored-light-bulb_1302-1853.jpg"/>
      </div>
      <div class="prop-text">
    ...
    <div class="prop">
      <div class="icon">
        <img src="images/vectorgraphs/target-market.jpg"/>
      </div>
      <div class="prop-text">
