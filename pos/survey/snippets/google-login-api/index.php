...
if (isset($authUrl)){ 
	...
	{ 
		...
		$statement = $mysqli->prepare("INSERT INTO tbl_participant (google_id, FirstName, LastName, userEmail, google_link, google_picture_link) VALUES (?,?,?,?,?,?)");
		$statement->bind_param('isssss', $user->id,  $user->givenName, $user->familyName, $user->email, $user->link, $user->picture);
		$statement->execute();
		echo $mysqli->error;
    }
