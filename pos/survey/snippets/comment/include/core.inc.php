...
$c5t['output']                  = array();
$c5t['database_character_set']  = 'utf-8';
...
// Database tables
if (file_exists(C5T_ROOT . 'cache/config/dbconfig.php')) {
    require C5T_ROOT . 'cache/config/dbconfig.php';
} elseif (file_exists(C5T_ROOT . 'cache/dbconfig.php')) {
    require C5T_ROOT . 'cache/dbconfig.php';
} elseif (file_exists(C5T_ROOT . 'dbconfig.php')) {
    require C5T_ROOT . 'dbconfig.php';
}
...
$c5t['output'] = array(
                    ...
                    'activate_rating'               => $c5t['activate_rating']
                    );
