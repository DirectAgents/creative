...
<a href="step3.php">    
    <div class="col-sm-4 processmenu-active">
<div class="onboarding-trigger-menu" ng-click="initTour()" ng-show="!user.isDeveloper" role="button" tabindex="0" aria-hidden="false">
      <span class="fa-stack fa-md">
        <i class="fa fa-circle-thin fa-stack-2x"></i>
        <i class="fa fa-info fa-stack-1x"></i>
...
<div class="survey-info">
          ...
          <img src="../uploads/<?PHP echo $rowproject['project_image']; ?>" class="preview">
...
<div id="saveproject">
        ...
        <input type="submit" id="testing" name="testing" value="Save Project"/>
