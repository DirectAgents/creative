...
if(isset($_POST["interests"]) && strlen($_POST["interests"])>0)
{
    ...
    if(mysqli_query($connecDB,"INSERT INTO tbl_participant_interests(userID,Interests) VALUES('".$userID."','".$contentToSave."')"))
    {
        //Record is successfully inserted, respond to ajax request
         $Interest = mysqli_query($connecDB,"SELECT * FROM tbl_participant_interests WHERE userID='".$userID."' AND Interests = '".$contentToSave."'");
...
{//do we have a delete request? $_POST["recordToDelete"]
    ...
    if(!mysqli_query($connecDB,"DELETE FROM tbl_participant_interests WHERE id=".$idToDelete))
    {
