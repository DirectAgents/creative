...
if (isset($_SESSION['access_token']) && $_SESSION['access_token']) {
 ...
 if (!isset($authUrl)){ 
  ...
  { 
    ...
    $date = date('Y-m-d'); 
        //echo 'Hi '.$user->name.', Thanks for Registering! [<a href="'.$redirect_uri.'?logout=1">Log Out</a>]';
    $insert_sql = mysqli_query($connecDB,"INSERT INTO tbl_participant (google_id, FirstName, LastName, userEmail, google_picture_link, Date_Created, account_verified) 
  ...
  else
  {
    ...
    {     
      ...
      $message = "          
            ...
            <br /><br />
            <a href='http://localhost/survey/participant/account/verify.php?id=$id&code=$code'>Click HERE to Activate :)</a>
            <br /><br />
            Thanks,";
...
<div class="loginas">
  <h3>Are you a <span class="role">Researcher</span>? <a href="<?php echo BASE_PATH; ?>/researcher/signup/">Click here</a></h3>
</div>
