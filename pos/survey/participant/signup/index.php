                                            ...
                                            <tbody>
                                              <tr>
                                                <td valign="top" align="center" style="padding: 40px 0 0 0; text-decoration:none" class="mobile-hide">
                                                 ...
                                                 <a href="http://localhost/creative/pos/survey/participant/account/verify.php?id='.$id.'&code='.$code.'">
...
<form class="form-signin" method="post">
  ...
  <div class="name-field col-md-6">
      <div class="form-group">
   <select name="txtage" class="txtage" oninvalid="this.setCustomValidity('Select your age')" oninput="setCustomValidity('')" required>
