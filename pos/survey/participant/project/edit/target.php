...
//$all_game_value = implode(",",$_POST['testing']);
  ...
  WHERE userID='".$_SESSION['researcherSession']."' AND id= '".$_SESSION['projectid']."'";
...
PotentialAnswer3) VALUES('".$_SESSION['researcherSession']."','".$_SESSION['projectid']."','".$_POST['potentialanswer1']."',
