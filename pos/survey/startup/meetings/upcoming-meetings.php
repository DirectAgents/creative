...
$sql=mysqli_query($connecDB,"SELECT * FROM tbl_project_request WHERE startupID = '".$_SESSION['startupSession']."' AND Status = 'Meeting Set' AND Accepted_to_Participate = 'Accepted' ORDER BY id DESC ");
