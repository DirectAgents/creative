...
if(isset($_POST["interests"]) && strlen($_POST["interests"])>0)
{
    ...
    if(mysqli_query($connecDB,"INSERT INTO tbl_startup_interests(userID, ProjectID, Interests) VALUES('".$userID."','".$projectID."','".$contentToSave."')"))
    {   

        $Interest = mysqli_query($connecDB,"SELECT * FROM tbl_startup_interests WHERE userID='".$userID."' AND 
        ...
        $Interest = mysqli_query($connecDB,"SELECT * FROM tbl_startup_interests WHERE id=".$idToDelete);
...
{//do we have a delete request? $_POST["recordToDelete"]
    ...
    if(!mysqli_query($connecDB,"DELETE FROM tbl_startup_interests WHERE id=".$idToDelete))
    {
