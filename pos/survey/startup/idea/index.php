...
$stmt = $startup_home->runQuery("SELECT * FROM tbl_startup_project WHERE ProjectID='".$_GET['id']."'");
...
<div class="container">
  ...
  echo '<img src="'.BASE_PATH.'/startup/project/uploads/'.$row['project_image'].'" class="img-circle-profile"/>';

}else{

 echo '<img src="'.BASE_PATH.'/startup/project/uploads/thumbnail.jpg" class="img-circle-profile"/>';
}
