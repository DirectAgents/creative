...
WePay.OAuth2.button_init(document.getElementById('start_oauth2'), {
    ...
    if (data.code.length !== 0) {
      ...
      window.location.href = "http://localhost/survey/startup/account/wepay/oauth2/token/?client_id=164910&code="+data.code+"&redirect_uri=http://localhost/survey/startup/account/wepay/&client_secret=9983463efa&code="+data.code;
