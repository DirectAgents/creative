  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      <ul class="nav navbar-nav navbar-right">
        <li><a href="<?php echo BASE_PATH; ?>/participant/signup.php">Become a Participant</a></li>
        <li><a href="<?php echo BASE_PATH; ?>/participant/login.php">Login</a></li>
...
<nav class="navbar navbar-default">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      <ul class="nav navbar-nav navbar-right">
        <li><a href="<?php echo BASE_PATH; ?>/participant">My Projects</a></li>
        <li class="dropdown">
