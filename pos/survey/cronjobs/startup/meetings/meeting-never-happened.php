...
$sql=mysqli_query($connecDB,"SELECT * FROM tbl_meeting_upcoming WHERE Met = '' ORDER BY id DESC ");
...
$dtB = new DateTime($row['Date_of_Meeting'].' '.$row['Final_Time']);
...
$sql=mysqli_query($connecDB,"DELETE FROM tbl_meeting_upcoming WHERE ProjectID = '".$row['ProjectID']."' AND userID = '".$row['userID']."'");
