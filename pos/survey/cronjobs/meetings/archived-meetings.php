...
$sql=mysqli_query($connecDB,"SELECT * FROM tbl_project_request WHERE Status = 'Meeting Set' AND Met = '' OR Status = 'Meeting Set' AND Met = 'No didn\'t show up' ORDER BY id DESC ");
