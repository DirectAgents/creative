...
$insert_sql = mysqli_query($connecDB,"INSERT INTO tbl_meeting_archived(userID, startupID, ProjectID, Status, Viewed_by_Startup, Viewed_by_Participant, Date_of_Meeting, Final_Time, Location, Startup_Email_Recent_Meeting_Reminder_Sent ,Date_Posted, Time_Posted) VALUES('".$rowparticipant['userID']."','".$rowstartup['userID']."',
