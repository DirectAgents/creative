...
$insert_sql = "INSERT INTO tbl_project_request(userID, startupID, ProjectID, Date_of_Meeting, From_Time, To_Time, Location, Status, Requested_By, Date_Posted, Time_Posted) 
VALUES('".$_SESSION['participantSession']."', '".$_POST['startupid']."','".$_POST['projectid']."','".$_POST['date']."', '".$_POST['fromtime']."', '".$_POST['totime']."', '".$_POST['location']."' , 'Waiting to Accept or Decline', 'Participant' ,'".$the_date."','".$the_time."')";
...
$sql5 = mysql_query("SELECT * FROM tbl_startup WHERE startupID='".$_POST['startupid']."'");
