...
<html lang="en" id="features" class="tablet mobile">
 ...
 <link rel="stylesheet" href="<?php echo BASE_PATH; ?>/startup/idea/css/jquery-ui.css">
     ...
     if (blank) {
      ...
      var dataURI = signaturePad.toDataURL("image/jpg")
       ...
       if(proceed) //everything looks good! proceed...
        ...
        $.ajax({
            method: "POST",
            url: "../../pdf/signatures/edit-startup.php",
...
<div class="col-lg-2"><input type="text" style="width:250px" name="startup_sig_name" id="startup_sig_name" placeholder="Your Full Name" value="<?php echo $rowsqlnda['startup_sig_name']; ?>" />
</div>
</div>
...
<div class="col-lg-2"><input type="text" style="width:250px" name="startup_sig_title" id="startup_sig_title" placeholder="Your Title (optional)" value="<?php echo $rowsqlnda['startup_sig_title']; ?>"  /></div>
</div>
...
<div class="col-lg-4"><input type="text" style="width:250px" name="startup_sig_company" id="startup_sig_company" placeholder="Your Company Name (optional)" value="<?php echo $rowsqlnda['startup_sig_company']; ?>" /></div>
</div>
...
<input type="text" style="width:250px" name="startup_sig_date" id="startup_sig_date" placeholder="Today's Date" value="<?php echo $thedate; ?>" />
