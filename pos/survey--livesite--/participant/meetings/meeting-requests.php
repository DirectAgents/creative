...
<?php if($row2['Status'] == 'Waiting for Startup to Accept or Decline' && $row2['ScreeningQuestion'] != 'Not Passed') { ?>
         ...
         <div class="thenote">
                   <?php if($row2['Status'] == 'Waiting for Participant to Accept or Decline' && $row2['ScreeningQuestion'] != 'Not Passed' && $rowparticipant['Phone'] == ''){echo 'Note: Your Phone number is required to accept this request. Please add one under Settings';} ?>
         </div>                 
