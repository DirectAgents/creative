...
$sql = "SELECT * FROM languages WHERE language='".$_POST["languages"]."'";
...
if(isset($_POST["languages"]) && strlen($_POST["languages"])>0)
{
    ...
    if(mysql_query("INSERT INTO tbl_participant_languages(userID, Languages) VALUES('".$userID."','".$contentToSave."')"))
    {
...
{//do we have a delete request? $_POST["recordToDelete"]
    ...
    if(!mysql_query("DELETE FROM tbl_participant_languages WHERE id=".$idToDelete))
    {
