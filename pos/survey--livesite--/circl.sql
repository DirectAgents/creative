...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 03, 2017 at 10:37 PM
...
CREATE TABLE IF NOT EXISTS `tbl_project_request` (
  ...
  `Participant_Email_Reminder_Sent` varchar(255) NOT NULL,
  `Startup_Email_Reminder_Sent` varchar(255) NOT NULL,
