...
<?php
$stmt2 = $startup_home->runQuery("SELECT * FROM tbl_project_request WHERE userID='".$_GET['id']."' AND ProjectID = '".$_GET['p']."' AND Day = 'Monday'");
...
<?php
$stmt3 = $startup_home->runQuery("SELECT * FROM tbl_project_request WHERE userID='".$_GET['id']."' AND ProjectID = '".$_GET['p']."' AND Day = 'Tuesday'");
...
<?php
$stmt4 = $startup_home->runQuery("SELECT * FROM tbl_project_request WHERE userID='".$_GET['id']."' AND ProjectID = '".$_GET['p']."' AND Day = 'Wednesday'");
...
<?php
$stmt5 = $startup_home->runQuery("SELECT * FROM tbl_project_request WHERE userID='".$_GET['id']."' AND ProjectID = '".$_GET['p']."' AND Day = 'Thursday'");
...
<?php if($row5['Location'] != '' && $row5['Accepted_to_Participate'] == 'Accepted' ){ ?>
 ...
 <?php
$stmt6 = $startup_home->runQuery("SELECT * FROM tbl_project_request WHERE userID='".$_GET['id']."' AND ProjectID = '".$_GET['p']."' AND Day = 'Friday'");
...
<?php if($row6['Location'] != '' && $row6['Accepted_to_Participate'] == 'Accepted' ){ ?>
 ...
 <?php
$stmt7 = $startup_home->runQuery("SELECT * FROM tbl_project_request WHERE userID='".$_GET['id']."' AND ProjectID = '".$_GET['p']."' AND Day = 'Saturday'");
...
<?php if($row7['Location'] != '' && $row7['Accepted_to_Participate'] == 'Accepted' ){ ?>
 ...
 <?php
$stmt8 = $startup_home->runQuery("SELECT * FROM tbl_project_request WHERE userID='".$_GET['id']."' AND ProjectID = '".$_GET['p']."' AND Day = 'Sunday'");
