...
<div class="note">
Suggest a Category you like to add your recommendations to:

 <div class="col_left">
    <input type="text" name="content_suggestcategory" id="contentSuggestcategory" placeholder="Enter a Category name here"/>
