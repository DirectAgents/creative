...
$redirect_uri = 'http://localhost/creative/pos/video/investors/';
 ...
 if (!isset($authUrl)){ 
  ...
  if($user->email) //if user already exist change greeting text to "Welcome Back"
    {   
        ...
        $_SESSION['investorSession'] = $row['userID'];
        //echo $_SESSION['startupSession'];
        header('Location: '.BASE_PATH.'/investors/profile/'.$_SESSION['investorSession'].'/');
  ...
  { 
    ...
    $insert_sql = mysqli_query($connecDB,"INSERT INTO tbl_investor (google_id, Fullname, Email, google_picture_link, Date_Created) 
...
$loginUrl = $helper->getLoginUrl(''.BASE_PATH.'/signup-callback-investor.php', $permissions);
...
if(isset($_SESSION['fb_access_token_investor'])){

try {
  // Returns a `Facebook\FacebookResponse` object
  $response = $fb->get('/me?fields=id,first_name, last_name,email,gender', $_SESSION['fb_access_token_investor']);
...
//check if user exist in database using COUNT
  ...
  { 
   ...
   date_default_timezone_set('America/New_York');
    ...
    $insert_sql = mysqli_query($connecDB,"INSERT INTO tbl_investor (facebook_id, Fullname, Email, Gender, Date_Created) 
            ...
            <div class="wrapper">
                <nav class="nav--main">
                    <ul>
                        ...
                        <li id="menu-item-46" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-46"><a href="<?php echo BASE_PATH;?>">For Startups</a></li>
            ...
            <div class="container center-block">
                <div class="signup-container center-block">
                    ...
                    <div class="signup-card center-block">
                        ...
                        <h2 class="signup-card-title bold text-center">Sign in as an Investor!</h2>
