...
$stmt = mysqli_query($connecDB,"SELECT * FROM tbl_investor WHERE login_session='".$_COOKIE['RememberMe']."'");
...
<div class="form-login">
  ...
  <form class="login-form">
    ...
    <p class="message">Not registered? <a href="<?php echo BASE_PATH; ?>/investors/signup">Sign up</a></p>
