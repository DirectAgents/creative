...
$( document ).ready(function() {
   ...
   $('html, body').animate({
    ...
    <body class="page-template page-template-page-loyalty page-template-page-loyalty-php page page-id-21 page-child parent-pageid-17 optimizely-21">
        <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-T7CJQ8" height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
      ...
      <div class="grid grid--section">
        ...
        <div class="grid__column u-size-1of2--md">
            ...
            <select id="industry" class="js-calculator-input">
			  ...
			  <option value="beauty">Beauty and Spa</option>
			  <option value="coffee">Coffee and Tea</option>
			  <option value="desserts">Desserts</option>
			  <option value="active-life">Fitness</option>
              <option value="restaurant">Food</option>
			  <option value="local">Local Service</option>
			  <option value="mobile-phone">Mobile Phone</option>
              <option value="nightlife">Nightlife</option>
              <option value="shopping">Shopping/Other</option>
            </select>
          </div>
