...
if (isset($_SESSION['access_token']) && $_SESSION['access_token']) {
 ...
 if (!isset($authUrl)){ 
  ...
  { 
    ...
    $insert_sql = mysqli_query($connecDB,"INSERT INTO tbl_startup (google_id, Fullname, Email, google_picture_link, Date_Created, account_verified) 
...
?>
  ...
  <div class="logo">
      <a href="<?php echo BASE_PATH; ?>"><img src="<?php echo BASE_PATH; ?>/images/logo@2x-2.png" width="142" height="60"/></a>
  </div>
</div>
