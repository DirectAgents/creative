        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <?php 
                    $sql = "SELECT * FROM tbl_startup ORDER BY userID DESC";  
                    ...
                    <div class="col-md-4 col-lg-4 col-xs-12 col-sm-6"> 
                        <div class="white-box">
                            ...
                            <span class="m-r-10"><a class="text-muted m-l-10" href="#"><i class="fa fa-heart-o"></i> 38</a></span>  
                            <a class="text-muted m-l-10" href="#"><i class="fa fa-heart-o"></i> Mobile</a></div>
                            <h3 class="m-t-20 m-b-20">Top 20 Models are on the ramp</h3>
                            
                            <button class="btn btn-success btn-rounded waves-effect waves-light m-t-20">Visit Profile</button>
                        </div>
                    </div>
