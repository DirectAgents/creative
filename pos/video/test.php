...
<body class="fix-header">
    ...
    <!-- /#wrapper -->
    <!-- jQuery -->
    <script src="https://wrappixel.com/ampleadmin/ampleadmin-html/plugins/bower_components/jquery/dist/jquery.min.js"></script>
    <!-- Bootstrap Core JavaScript -->
    <script src="https://wrappixel.com/ampleadmin/ampleadmin-html/ampleadmin/bootstrap/dist/js/bootstrap.min.js"></script>
    <!-- Menu Plugin JavaScript -->
    <script src="https://wrappixel.com/ampleadmin/ampleadmin-html/plugins/bower_components/sidebar-nav/dist/sidebar-nav.min.js"></script>
    <!--slimscroll JavaScript -->
    <script src="https://wrappixel.com/ampleadmin/ampleadmin-html/ampleadmin/js/jquery.slimscroll.js"></script>
    <!--Wave Effects -->
    <script src="https://wrappixel.com/ampleadmin/ampleadmin-html/ampleadmin/js/waves.js"></script>
    <!-- Custom Theme JavaScript -->
    <script src="https://wrappixel.com/ampleadmin/ampleadmin-html/ampleadmin/js/custom.min.js"></script>
    <!-- Footable -->
    <script src="https://wrappixel.com/ampleadmin/ampleadmin-html/plugins/bower_components/footable/js/footable.all.min.js"></script>
    <script src="https://wrappixel.com/ampleadmin/ampleadmin-html/plugins/bower_components/bootstrap-select/bootstrap-select.min.js" type="text/javascript"></script>
    <!--FooTable init-->
    <script src="https://wrappixel.com/ampleadmin/ampleadmin-html/ampleadmin/js/footable-init.js"></script>
    <!--Style Switcher -->
    <script src="https://wrappixel.com/ampleadmin/ampleadmin-html/plugins/plugins/bower_components/styleswitcher/jQuery.style.switcher.js"></script>
</body>
