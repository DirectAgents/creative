...
$time = date('h:i:s A');  
 ...
 $insert_sql = mysqli_query($connecDB,"INSERT INTO contact_form(Fullname, Email, Message, Date, Time) VALUES('".$_POST['fm_name']."', '".$_POST['fm_email']."' ,'".htmlspecialchars($_POST['fm_message'])."', '".$date."', '".$time."')");
...
$from = new SendGrid\Email("Contact Form TheFundry.com", "support@valifyit.com");
$subject = "Contact Form TheFundry.com";
                                    ...
                                    <div style="display:inline-block; margin: 0 -2px; max-width:600px; vertical-align:top; width:100%;">
                                        ...
                                        <table align="left" border="0" cellpadding="0" cellspacing="0" width="100%">
                                            ...
                                            <tr>
                                             ...
                                             <tr>
                                                 <td align="left" style="padding: 0 0 5px 25px; font-size: 18px; font-family: Helvetica, Arial, sans-serif; font-weight: normal; color: #333333;" class="padding">
                                                <br><br>Message:<br><br>'.nl2br(htmlspecialchars($_POST['fm_message'])).'
                                                </td>
                                            </tr>
