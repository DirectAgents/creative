...
if (isset($_SESSION['access_token']) && $_SESSION['access_token']) {
 ...
 if (!isset($authUrl)){ 
  ...
  $result = mysqli_query($connecDB,"SELECT COUNT(userEmail) as usercount FROM tbl_customer WHERE userEmail='".$user->email."' ");
  ...
  if($user_count) //if user already exist change greeting text to "Welcome Back"
    ...
    $statement = $mysqli->prepare("UPDATE tbl_customer SET 
    profile_image = '',
    facebook_id = '',
    google_id = '".$user->id."',
...
$loginUrl = $helper->getLoginUrl(''.BASE_PATH.'/login/login-callback.php', $permissions);
...
//check if user exist in database using COUNT
  ...
  $resultfacebook = mysqli_query($connecDB,"SELECT COUNT(facebook_id) as usercountfacebook FROM tbl_customer WHERE userEmail='".$user['email']."' ");
