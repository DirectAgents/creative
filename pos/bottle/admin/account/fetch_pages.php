...
$( "#pickup-requests" ).load( "pickup-requests.php" );

    $(".pickup-requests").click(function() {  
     ...
     $(".upcoming-pickups").click(function() {  
      ...
      $( "#upcoming-pickups" ).load( "upcoming-pickups.php" );
      ...
      $( "#upcoming-pickups" ).load( "upcoming-pickups.php" );
       ...
       $(".finished-pickups").click(function() {  

      $( "#finished-pickups" ).load( "finished-pickups.php" );
    ...
    $(".completed-tasks").click(function() {  
      ...
      $( "#completed-tasks" ).load( "completed-tasks.php" );
...
<div id="tabs">
 ...
 <ul>
    <li><a href="#pickup-requests" class="pickup-requests">Pickup Requests</a></li>
    <li>&nbsp;</li>
    <li><a href="#upcoming-pickups" class="upcoming-pickups">Upcoming Pickups</a></li>
    <li>&nbsp;</li>
    <li><a href="#finished-pickups" class="finished-pickups">Finished Pickups</a></li>
    <li>&nbsp;</li>
    <li><a href="#completed-tasks" class="completed-tasks">Completed Tasks</a></li>
...
<div id="pickup-requests" class="tabContent" > </div>

<div id="upcoming-pickups" class="tabContent" ></div>

<div id="finished-pickups" class="tabContent" ></div>

<div id="completed-tasks" class="tabContent" > </div>
