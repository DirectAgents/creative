 ...
 //get input field values
      ...
      $(".close-accept").show();
          ...
          $( ".processing" ).show();
            ...
            //Ajax post data to server
            $.post('deny-pickup-date.php', post_data, function(response){  
              //alert("yes"); 
...
?>
 ...
 <div class="btn-browse">
                       <a href="#" role="button" class="slide-deny<?php echo $row2['id']; ?>_<?php echo $random; ?>_open"> Deny </a>
                        </div>
