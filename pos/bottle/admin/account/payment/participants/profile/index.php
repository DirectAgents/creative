...
{
  $startup_home->redirect('../../../../login/startup.php');
}
...
<?php
$stmt2 = $startup_home->runQuery("SELECT * FROM tbl_participant_request WHERE userID='".$_GET['id']."' AND ProjectID = '".$_GET['p']."' AND Day = 'Monday'");
$stmt2->execute(array(":uid"=>$_SESSION['startupSession']));
...
<?php
$stmt3 = $startup_home->runQuery("SELECT * FROM tbl_participant_request WHERE userID='".$_GET['id']."' AND ProjectID = '".$_GET['p']."' AND Day = 'Tuesday'");
$stmt3->execute(array(":uid"=>$_SESSION['startupSession']));
...
<?php
$stmt4 = $startup_home->runQuery("SELECT * FROM tbl_participant_request WHERE userID='".$_GET['id']."' AND ProjectID = '".$_GET['p']."' AND Day = 'Wednesday'");
$stmt4->execute(array(":uid"=>$_SESSION['startupSession']));
...
<?php
$stmt5 = $startup_home->runQuery("SELECT * FROM tbl_participant_request WHERE userID='".$_GET['id']."' AND ProjectID = '".$_GET['p']."' AND Day = 'Thursday'");
$stmt5->execute(array(":uid"=>$_SESSION['startupSession']));
...
?>
 ...
 <?php
$stmt6 = $startup_home->runQuery("SELECT * FROM tbl_participant_request WHERE userID='".$_GET['id']."' AND ProjectID = '".$_GET['p']."' AND Day = 'Friday'");
$stmt6->execute(array(":uid"=>$_SESSION['startupSession']));
...
?>   
 ...
 <?php
$stmt7 = $startup_home->runQuery("SELECT * FROM tbl_participant_request WHERE userID='".$_GET['id']."' AND ProjectID = '".$_GET['p']."' AND Day = 'Saturday'");
$stmt7->execute(array(":uid"=>$_SESSION['startupSession']));
...
?>  
 ...
 <?php
$stmt8 = $startup_home->runQuery("SELECT * FROM tbl_participant_request WHERE userID='".$_GET['id']."' AND ProjectID = '".$_GET['p']."' AND Day = 'Sunday'");
$stmt8->execute(array(":uid"=>$_SESSION['startupSession']));
