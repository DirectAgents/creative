    ...
    <div class="col-md-10">
                  ...
                  <div class="survey-header">
                    ...
                    <div class="edit-delete">
                      <a href="<?php echo BASE_PATH; ?>/startup/project/edit/step1.php?id=<?php echo $row2['ProjectID']; ?>">
...
?>
                  ...
                  <div class="action" tabindex="0" aria-hidden="false">
                      ...
                      <div class="action" ng-click="triggerPreview(survey)" ng-show="survey.surveyLength > 0" role="button" tabindex="0" aria-hidden="false">
                       ...
                       <a href="../ideas/<?php echo $row2['Category']; ?>/?id=<?php echo $row2['ProjectID']; ?>"> Preview </a>
