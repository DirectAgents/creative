...
$sql_participant = mysqli_query($connecDB,"SELECT * FROM tbl_pickup_request WHERE RequestID = '".$_POST['requestid']."' AND userID = '".$_POST['userid']."'");
$row = mysqli_fetch_array($sql_participant);


$date_of_pickup1  = $row['Schedule_Date_Option1']; $time1 = $row['Schedule_Time_Option1']; 
$date_of_pickup2  = $row['Schedule_Date_Option2']; $time2 = $row['Schedule_Time_Option2']; 
$date_of_pickup3 = $row['Schedule_Date_Option3']; $time3 = $row['Schedule_Time_Option3']; 
...
$date_of_pickup1 = date('F j, Y',strtotime($date_of_pickup1)).' @ '.$time1;
$date_of_pickup2 = date('F j, Y',strtotime($date_of_pickup2)).' @ '.$time2;
$date_of_pickup3 = date('F j, Y',strtotime($date_of_pickup3)).' @ '.$time3;
                                            ...
                                            <tbody><tr>
                                                ...
                                                <td style="padding: 40px 0 0 0;" class="no-padding">
                                                    ...
                                                    <table border="0" cellspacing="0" cellpadding="0" width="100%">
                                                        ...
                                                        <tr>
                                                            <td align="left" style="padding: 0 0 5px 25px; font-size: 14px; font-family: Helvetica, Arial, sans-serif; font-weight: normal; color: #333333;" class="padding">'.$date_of_pickup1.'</td>

                                                        </tr>

                                                         <tr>
                                                            <td align="left" style="padding: 10px 0 5px 25px; font-size: 14px; font-family: Helvetica, Arial, sans-serif; font-weight: normal; color: #333333;" class="padding">'.$date_of_pickup2.'</td>

                                                        </tr>

                                                         <tr>
                                                            <td align="left" style="padding: 10px 0 5px 25px; font-size: 14px; font-family: Helvetica, Arial, sans-serif; font-weight: normal; color: #333333;" class="padding">'.$date_of_pickup3.'</td>
