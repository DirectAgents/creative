...
-->
  ...
  <header class="hero">
    ...
    <div class="wrap">
      <h1 class="title">Earn money and Help the Homeless</h1>
      <span class="description">
         Help the homeless + Earn extra money
      </span>
...
<div id="benefits"></div>
      ...
      <div class="wrapper">
          ...
          <div class="feature"
              ...
              ng-class="{
               ...
               <div class="icon-features">
               <img src="img/features/homeless.png"/>
              </div>
              <h2 class="title">Help the Homeless</h2>
              <span class="description">We are not donating money to charity. The help goes directly to the homeless in need.</span>
  ...
  <section class="features" style="background:#fff"
      ...
      <div class="feature"
              ...
              <span class="description">People forget to recycle bottles and cans</span>
