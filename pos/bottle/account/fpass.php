...
if(isset($_POST['btn-submit']))
{
	...
	$stmt = $user->runQuery("SELECT userID FROM tbl_customer WHERE userEmail=:email LIMIT 1");
	...
	if($stmt->rowCount() == 1)
	{
		...
		$stmt = $user->runQuery("UPDATE tbl_customer SET tokenCode=:token WHERE userEmail=:email");
...
$from = new SendGrid\Email("Password Recovery", "support@misterpao.com");
                                            ...
                                            <tbody>
                                              <tr>
                                                <td valign="top" align="center" style="padding: 40px 0 0 0; text-decoration:none" class="mobile-hide">
                                                 ...
                                                 <a href="'.BASE_PATH.'/account/resetpass.php?id='.$id.'&code='.$code.'">
                                                ...
                                                <img alt="Logo" src="https://misterpao.com/images/email/reset-password.png" width="219" height="15" style="display: block; border="0">
                                                </div>
                                                </a>
