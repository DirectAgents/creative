...
-->
  ...
  <header class="hero">
    ...
    <div class="wrap">
      <h1 class="title">Get more customers + help the homeless</h1>
...
<input type="submit" value="Sign me up" name="btn-notify" id="btn-notify" class="hs-button primary large" rel="relativeanchor" data-reactid=".hbspt-forms-0.2.1.0"></div>
 ...
 <span class="note">
  ...
  <section class="value">
    ...
    <div class="prop">
      <div class="icon">
         <img src="images/homeless.jpg"/>
      </div>
      <div class="prop-text">
        <h2 class="title">Help the homeless</h2>
        <span class="description">Reach out to homeless directly</span>
        <ul>
          <li>The homeless receives food or clothes directly</li>
          <li>Help them to survive the next day</li>
          <li>Give the homeless a smile and make a positive impact to them</li>
        </ul>
      </div>
    </div>
    <div class="prop">
      ...
      <div class="prop-text">
        <h2 class="title">Donate your recycles</h2>
        <span class="description">Donate your recycles to your customers and the homeless around the block</span>
        <ul>
          <li>Make your customers happy and bring them back to dine </li>
          <li>Give a reason to your customers to like you even more</li>
          <li>You are helping your customers and the homeless</li>
        </ul>
      </div>
    </div>
  </section>
  ...
  <section class="features"
      ...
      <div class="wrapper">
          ...
          <div class="feature"
              ...
              <h2 class="title">Retain Your Customers</h2>
              <span class="description">
                With our new solution and approach we will make your current customers come back with a smile
              </span>
          ...
          <div class="feature"
              ...
              <h2 class="title">You focus on your business</h2>
              <span class="description">We will ask you to install or download app. You only recycle and we do the rest.</span>
          ...
          <div class="feature"
              ...
              <h2 class="title">Feel good about it</h2>
              <span class="description">Each bottles and cans you recycle it helps the environment, your customers and the homeless</span>
          ...
          <div class="feature"
              ...
              ng-class="{
               ...
               <div class="icon-features">
               <img src="img/features/water-bottle.png"/>
              </div>
              <h2 class="title">Donate your recycles</h2>
              <span class="description">Donate your recycles to your customers and the homeless around the block</span>
  ...
  <section class="features" style="background:#fff"
      ...
      <div class="wrapper">
          ...
          <div class="feature"
              ...
              <div class="icon-features">
               <img src="img/features/customer.png"/>
              </div>
              <h2 class="title">You need happy customers</h2>
              <span class="description">
               Your customers are the reason why your restaurant stays open. Make them happy and give them another reason to come back again.
              </span>
          ...
          <div class="feature"
              ...
              <div class="icon-features">
               <img src="img/features/advertising.png"/>
              </div>
              <h2 class="title">Advertising can be expensive</h2>
              <span class="description">To advertise can be time consuming and expensive.</span>
      ...
      <div class="feature"
              ...
              <h2 class="title">Customer may not come back</h2>
              <span class="description">Customers come and go.</span>
           ...
           <div class="feature"
              ...
              <div class="icon-features">
               <img src="img/features/promotion.png"/>
              </div>
              <h2 class="title">Promotions and Incentives</h2>
              <span class="description">You need to provide promotions or incentive during slow times to attain customers.</span>
